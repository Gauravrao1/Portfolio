        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                I build practical software, web, and API-driven projects that
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                I explore data, train models, and use analytics to build AI and
                machine learning solutions with measurable value.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
